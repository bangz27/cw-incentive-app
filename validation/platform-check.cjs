...
assert.deepEqual(config, json('android/app/src/main/assets/capacitor.config.json'));
...
assert.match(read('android/app/src/main/res/values/strings.xml'), />CW Incentive</);
