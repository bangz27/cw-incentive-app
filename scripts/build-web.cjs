...
const files = [
  ...
  'calculation-engine.js', 'two-w-config.js', 'record-model.js', 'profile-store.js', 'firebase-auth.js', 'support_qr.png', 'tbs_icon.png', 'tbs_banner.png', 'capacitor-core.js', 'capacitor-local-notifications.js'
];
